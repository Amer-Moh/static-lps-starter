!(function (n, t) {
  ...
  function v(n, t, r, u, s, a, d, l, f, p, h, y, v, b, S, w, E, L, D) {
    ...
    function q(n) {
      ...
      r > w && (j = !0), p.useFriction(0.3).useDuration(0.75), l.start(), s.add(M(i)), n.preventDefault();
    }
    function U(n) {
      const t = h.byDistance(0, !1).index !== y.get(),
        ...
        r = (function (n, t) {
          ...
          return S || o(n) < P ? r : E && t ? 0.5 * r : h.byIndex(e.get(), 0).distance;
        })(M(e), t),
        u = (function (n, t) {
          if (0 === n || 0 === t) return 0;
          if (o(n) <= o(t)) return 0;
          ...
          (e(D) || D(n, o)) &&
            (function (n) {
              ...
              (N = !0),
                ...
                (function () {
                  const n = G ? r : t;
                  O.add(n, "touchmove", q, F).add(n, "touchend", U).add(n, "mousemove", q, F).add(n, "mouseup", U);
                })(),
                (B = a.readPoint(n)),
                (C = a.readPoint(n, I)),
                v.emit("pointerDown");
      ...
      byDistance: function (e, r) {
        const i = c.get() + e,
          { index: s, distance: l } = (function (e) {
            const r = n ? a(e) : d(e),
              i = t.map((n, t) => ({ diff: f(n - r, 0), index: t })).sort((n, t) => o(n.diff) - o(t.diff)),
              { index: c } = i[0];
            return { index: c, distance: r };
          })(i),
          p = !n && u(i);
        return !r || p ? { index: s, distance: e } : { index: s, distance: e + f(t[s] - l, 0) };
      },
  ...
  function A(n, t, e, r, o, i, c, s, a) {
    ...
    function h(o, c, u) {
      const l = (function (n) {
        return i.map((e, o) => ({ start: e - r[o] + d + n, end: e + t - d + n }));
      })(c);
      return o.map((t) => {
        const r = u ? 0 : -e,
          o = u ? e : 0,
          i = u ? "end" : "start",
          c = l[t][i];
        return { index: t, loopPoint: c, slideLocation: I(-1), translate: M(n, a[t]), target: () => (s.get() > c ? r : o) };
      });
    }
    return {
      canLoop: function () {
  ...
  function P(n, e, r, f, p, m, P) {
    const {
      ...
      fn = -s(dn) + s(cn),
      { snapsContained: pn, scrollContainLimit: mn } = (function (n, t, e, r, o) {
        const i = x(-t + n, 0),
          u = e
            .map((n, t) => {
              const { min: r, max: o } = i,
      ...
      bn = h(
        ...
        p,
        () =>
          (({ dragHandler: n, scrollBody: t, scrollBounds: e, options: { loop: r } }) => {
        ...
        (n) =>
          ((
            ...
            const p = n.settled(),
              ...
              h = g && !u.pointerDown();
            h && s.stop();
            const x = e.get() * f + o.get() * (1 - f);
            r.set(x), l && (i.loop(n.direction()), c.loop()), t.to(r.get()), h && a.emit("settle"), g || a.emit("scroll");
          })(Hn, n)
      ),
      Sn = gn[xn.get()],
      wn = I(Sn),
      ...
      In = (function (n, t, e, r, c, u) {
        ...
        const h = {
          ...
          seek: function () {
            const t = r.get() - n.get();
            let o = 0;
            return d ? (e.set(n), (s += t / d), (s *= l), (f += s), n.add(s), (o = f - p)) : ((s = 0), e.set(r), n.set(r), (o = t)), (a = i(o)), (p = f), h;
          },
          settled: function () {
      ...
      Hn = {
        ...
        animation: bn,
        axis: Z,
        dragHandler: v(Z, n, f, p, Dn, b(Z, p), wn, bn, An, In, Mn, xn, P, nn, N, R, q, 0.68, Q),
        eventStore: Tn,
        percentOfView: nn,
        index: xn,
        indexPrevious: yn,
  ...
  function k(n, e, r) {
    const o = n.ownerDocument,
      ...
      u = (function (n) {
        ...
        return {
          init: function (e, r) {
            return (t = r.filter(({ options: t }) => !1 !== n.optionsAtMedia(t).active)), t.forEach((t) => t.init(e, n)), r.reduce((n, t) => Object.assign(n, { [t.name]: t }), {});
          },
          destroy: function () {
    ...
    function M(e, r) {
      w ||
        ...
        (y = I(L)),
        f([E, ...D.map(({ options: n }) => n)]).forEach((n) => s.add(n, "change", A)),
        L.active &&
